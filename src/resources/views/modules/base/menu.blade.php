...
<nav class="atelier-admin-menu">
	<ul>
		@foreach ( $bookTypes as $bookType )
			<li>
				<a  class="icon" href="{{ url('/iba/analog/' . $bookType . '/create') }}"><i class="fa fa-plus" aria-hidden="true"></i>
</a>
				<a class="text" href="{{  url('/iba/analog/' . $bookType ) }}">{{ title_case($bookType) }}</a>
			</li>
		@endforeach
			<li>
				<a class="icon" href="{{ url('/iba/analog/bundle/create') }}"><i class="fa fa-plus" aria-hidden="true"></i>
</a>
